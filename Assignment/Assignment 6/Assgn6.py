...
ust = tk.OptionMenu(root, usrtype, "User", "Group", "Other")
...
my_label3 = tk.Label(root, text = "Mask Value for files ")
...
my_label3 = tk.Label(root, text = "Mask Value for Directory")
